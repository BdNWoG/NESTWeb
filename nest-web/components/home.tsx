 ...
 * @see https://v0.dev/t/eOSoUGENL14
 */
            ...
            <div className="grid gap-6 lg:grid-cols-[1fr_400px] lg:gap-12 xl:grid-cols-[1fr_600px]">
              ...
              <div className="flex flex-col justify-center space-y-4">
                ...
                <div className="flex flex-col gap-2 min-[400px]:flex-row">
                  ...
                  <Link
                    className="inline-flex h-10 items-center justify-center rounded-md border border-gray-200 bg-white px-8 text-sm font-medium shadow-sm transition-colors hover:bg-gray-100 hover:text-gray-900 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-gray-950 disabled:pointer-events_none disabled:opacity-50 dark:border-gray-800 dark:bg-gray-950 dark:hover:bg-gray-100 dark:hover:text-gray-950 dark:focus-visible:ring-gray-950 dark:border-gray-800"
                    href="#"
                  >
                    Contact Sales
                  </Link>
